...
import { updatePicturepic } from '../../reduxToolkit/UserSlice';
...
const UpdateProfilePicture = ({setImage ,image,setError ,setshow ,pRef }) => {
    ...
    const updateProfielPicture = async () => {
      try {
        ...
        const updated_picture = await UpdateProfile(
          res[0].url,
          user.token
        );
  ...
  return (
    ...
    <div className="update_submit_wrap">
      ...
      <button className="blue_btn" onClick={() => updateProfielPicture()} disabled={loading}>
